...
public class Generator {
    ...
    public static final String LINK = "jdbc:mysql://127.0.0.1:3306/panamera?useUnicode=true&characterEncoding=utf-8";
    ...
    public static void main(String[] args) {
        ...
        PackageConfig packageConfig = new PackageConfig()
                .setParent("com.porsche.panamera.core.dal")
                .setEntity("domain")
                .setMapper("dao")
                .setService("manager")
                .setServiceImpl("manager.managerImpl");
